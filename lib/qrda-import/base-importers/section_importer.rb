  ...
  module Cat1
    class SectionImporter
      ...
      def extract_entity(parent_element, entity_xpath)
        ...
        return extract_care_partner_entity(care_partner_entity_element, entities) if care_partner_entity_element
        return extract_patient_entity(patient_entity_element, entities) if patient_entity_element
        return extract_practitioner_entity(practitioner_entity_element, entities) if practitioner_entity_element
        return extract_organization_entity(organization_entity_element, entities) if organization_entity_element
        return extract_location_entity(location_entity_element, entities) if location_entity_element
