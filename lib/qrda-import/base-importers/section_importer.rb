  ...
  module Cat1
    class SectionImporter
      ...
      def extract_entity(parent_element, entity_xpath)
        entities = []
        care_partner_entity_elements = parent_element.xpath(entity_xpath + "/cda:participantRole[cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.160']")
        patient_entity_elements = parent_element.xpath(entity_xpath + "/cda:participantRole[cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.161']")
        practitioner_entity_elements = parent_element.xpath(entity_xpath + "/cda:participantRole[cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.162']")
        organization_entity_elements = parent_element.xpath(entity_xpath + "/cda:participantRole[cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.163']")
        location_entity_elements = parent_element.xpath(entity_xpath + "/cda:participantRole[cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.555']")
        extract_care_partner_entity(care_partner_entity_elements, entities) if care_partner_entity_elements
        extract_patient_entity(patient_entity_elements, entities) if patient_entity_elements
        extract_practitioner_entity(practitioner_entity_elements, entities) if practitioner_entity_elements
        extract_organization_entity(organization_entity_elements, entities) if organization_entity_elements
        extract_location_entity(location_entity_elements, entities) if location_entity_elements
